    ...
    def enter(self):
        ...
        if (self.count < 6):
            ...
            if (len(entered_guess) == 5) and (entered_guess in self.word_list) and (status_code != 3):
                ...
                self.count += 1
                color_list = ['white','white','white','white','white']
                coordinates_list = []
                ...
                if self.num_correct == 5:
                    self.canvas.create_line(coordinates_list[0][0],coordinates_list[0][1],coordinates_list[1][0],coordinates_list[1][1], width=5)
                    self.canvas.create_line(coordinates_list[1][0],coordinates_list[1][1],coordinates_list[2][0],coordinates_list[2][1], width=5)
                    self.canvas.create_line(coordinates_list[2][0],coordinates_list[2][1],coordinates_list[3][0],coordinates_list[3][1], width=5)
                    self.canvas.create_line(coordinates_list[3][0],coordinates_list[3][1],coordinates_list[4][0],coordinates_list[4][1], width=5)
                    self.canvas.create_line(coordinates_list[4][0],coordinates_list[4][1],coordinates_list[0][0],coordinates_list[0][1],width=5)
